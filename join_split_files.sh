...
cat system/system/product/app/GoogleCameraGo/GoogleCameraGo.apk.* 2>/dev/null >> system/system/product/app/GoogleCameraGo/GoogleCameraGo.apk
rm -f system/system/product/app/GoogleCameraGo/GoogleCameraGo.apk.* 2>/dev/null
